                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="{{ asset('storage/'.$product->image) }}" alt="Product Image">
                            </div>

                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3" id="{{$product->sub_category}}"value="{{$product->name}}">{{$product->name}}</h6>
                            ...
                            <form action="{{route('increaseItem',$product->id)}}" method="POST">
                                @csrf
                                <i class="fas fa-shopping-cart text-primary mr-1"><button type="submit">Add to Cart</button></i>
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                        <a class="btn btn-success" href="{{ route('buyComponent',$product->id) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                        <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                        </svg>
                            <span id="productCount">{{$product->quantity}}</span> items in cart
                        </a>
                        </div>
                        </div>
                    </div>
