...
<head>
    ...
    <link href="{{ asset('login-web/css/bootstrap.css') }}" rel="stylesheet">
    <link href="{{ asset('login-web/css/fontawesome-all.css') }}" rel="stylesheet">
    <link href="{{ asset('login-web/css/swiper.css') }}" rel="stylesheet">
	<link href="{{ asset('login-web/css/magnific-popup.css') }}" rel="stylesheet">
	<link href="{{ asset('login-web/css/styles.css') }}" rel="stylesheet">

	<!-- Favicon  -->
    <link rel="icon" href="{{ asset('login-web/images/favicon.png') }}">
</head>
    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Log In</h1>
                   <p>You don't have a password? Then please <a class="white" href="{{ route('register.perform') }}">Sign Up</a></p>
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form method="post" action="{{ route('login.perform') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <div class="form-group">
                                <input type="email" class="form-control-input" name="username" id="username" required>
